...
import com.example.unicornfashion.AddSellerActivity;
import com.example.unicornfashion.MainActivity;
import com.example.unicornfashion.R;
import com.example.unicornfashion.SellerListActivity;
...
public class AdminCategoryActivity extends AppCompatActivity {
    ...
    private ImageView addSeller;

    private Button LogoutBtn, CheckOrdersBtn, ManageProduct, ViewSeller;
...
//        ManageProduct = (Button) findViewById(R.id.manage_Products);
        ViewSeller = (Button) findViewById(R.id.disply_seller);
...
//        });
        ...
        ViewSeller.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(AdminCategoryActivity.this, SellerListActivity.class);
        ...
        addSeller.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(AdminCategoryActivity.this, AddSellerActivity.class);
                intent.putExtra("category", "Seller");
                startActivity(intent);
            }
        });
