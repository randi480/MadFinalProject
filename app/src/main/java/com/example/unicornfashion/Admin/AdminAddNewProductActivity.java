package com.example.unicornfashion.Admin;
...
public class AdminAddNewProductActivity extends AppCompatActivity {
    ...
    private void ValidateProductData() {
        ...
        if (ImagrUri == null){
            ...
            Toast.makeText(AdminAddNewProductActivity.this, "Description is empty", Toast.LENGTH_SHORT).show();
        }
        else if(TextUtils.isEmpty(Price)){
            Toast.makeText(AdminAddNewProductActivity.this, "Price is empty", Toast.LENGTH_SHORT).show();
        }
        else if(TextUtils.isEmpty(Pname)){
            Toast.makeText(AdminAddNewProductActivity.this, "Name is empty", Toast.LENGTH_SHORT).show();
        }
        else{
