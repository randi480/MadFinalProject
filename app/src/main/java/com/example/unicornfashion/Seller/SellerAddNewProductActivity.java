...
public class SellerAddNewProductActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode==GalleryPick && resultCode == RESULT_OK && data != null){
            ...
            InputProductImage.setImageURI(ImagrUri);
    ...
    private void ValidateProductData() {
        ...
        if (ImagrUri == null){
            Toast.makeText(SellerAddNewProductActivity.this, "Product Image is Mandatory", Toast.LENGTH_SHORT).show();
        }
        else if(TextUtils.isEmpty(Description)){
            Toast.makeText(SellerAddNewProductActivity.this, "Description is empty", Toast.LENGTH_SHORT).show();
        }
        else if(TextUtils.isEmpty(Price)){
            Toast.makeText(SellerAddNewProductActivity.this, "Price is empty", Toast.LENGTH_SHORT).show();
        }
        else if(TextUtils.isEmpty(Pname)){
            Toast.makeText(SellerAddNewProductActivity.this, "Name is empty", Toast.LENGTH_SHORT).show();
        }
        else{
    ...
    private void StoreProductInformation() {
        ...
        final StorageReference filePath = ProductImageRef.child(ImagrUri.getLastPathSegment() + ProductRandomKey + ".jpg");
                ...
                Task<Uri> uriTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task) {
                        if (task.isSuccessful()){
                            ...
                            Toast.makeText(SellerAddNewProductActivity.this, "Got product Image Successfully", Toast.LENGTH_SHORT).show();
    ...
    private void saveProductInfoToDatabasr() {
        ...
        productMap.put("sellerEmail", sPhone);
        productMap.put("sellerPhone", sEmail);
